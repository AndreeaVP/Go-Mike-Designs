! function (a) {
            ...
            methods: {
                init: function (o) {
                    ...
                    return a(l).bind("submit", function (t) {
                        ...
                        }), n.trigger("validationLostFocus.validation"), i ? (r.options.preventSubmit && t.preventDefault(), e.addClass("error"), a.isFunction(r.options.submitError) && r.options.submitError(e, t, n.jqBootstrapValidation("collectErrors", !0))) : (e.removeClass("error"), a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(e, t))
                    }), this.each(function () {
                        var e = a(this),
                        ...
                        if (!l.length && r.options.autoAdd && r.options.autoAdd.helpBlocks && (l = a('<div class="help-block" />'), o.append(l), t.push(l[0])), r.options.sniffHtml) {
                            ...
                            if (void 0 !== e.attr("pattern") && (c = "Not in the expected format<!-- data-validation-pattern-message to override -->", e.data("validationPatternMessage") && (c = e.data("validationPatternMessage")), e.data("validationPatternMessage", c), e.data("validationPatternRegex", e.attr("pattern"))), void 0 !== e.attr("max") || void 0 !== e.attr("aria-valuemax")) {
                                ...
                                c = "Too high: Maximum of '" + v + "'<!-- data-validation-max-message to override -->", e.data("validationMaxMessage") && (c = e.data("validationMaxMessage")), e.data("validationMaxMessage", c), e.data("validationMaxMax", v)
                            }
                        ...
                        void 0 !== e.data("validation") && (s = e.data("validation").split(",")), a.each(e.data(), function (a, t) {
                            var e = a.replace(/([A-Z])/g, ",$1").split(",");
                            "validation" === e[0] && e[1] && s.push(e[1])
                        });
                        var u = s,
                            g = [];
                        do a.each(s, function (a, t) {
                            s[a] = i(t)
                        }), s = a.unique(s), g = [], a.each(u, function (t, n) {
                            if (void 0 !== e.data("validation" + n + "Shortcut")) a.each(e.data("validation" + n + "Shortcut").split(","), function (a, t) {
                                g.push(t)
                            });
                        ...
                        }), u = g; while (u.length > 0);
                        var h = {};
                        a.each(s, function (t, n) {
                            var o = e.data("validation" + n + "Message"),
                                l = void 0 !== o,
                                d = !1;
                            if (o = o || "'" + n + "' validation failed <!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message -->", a.each(r.validatorTypes, function (t, r) {
                                    void 0 === h[t] && (h[t] = []), d || void 0 === e.data("validation" + n + i(r.name)) || (h[t].push(a.extend(!0, {
                                        name: i(r.name),
                                        message: o
                                    }, r.init(e, n))), d = !0)
                                ...
                                "shortcut" === c ? d = !0 : a.each(r.validatorTypes, function (t, o) {
                        ...
                        }), l.data("original-contents", l.data("original-contents") ? l.data("original-contents") : l.html()), l.data("original-role", l.data("original-role") ? l.data("original-role") : l.attr("role")), o.data("original-classes", o.data("original-clases") ? o.data("original-classes") : o.attr("class")), e.data("original-aria-invalid", e.data("original-aria-invalid") ? e.data("original-aria-invalid") : e.attr("aria-invalid")), e.bind("validation.validation", function (t, i) {
                            var o = n(e),
                                l = [];
                            return a.each(h, function (t, n) {
                                (o || o.length || i && i.includeEmpty || r.validatorTypes[t].blockSubmit && i && i.submitting) && a.each(n, function (a, i) {
                            ...
                            o.find("input,textarea,select").each(function (t, n) {
                                var o = c.length;
                                if (a.each(a(n).triggerHandler("validation.validation", i), function (a, t) {
                                        c.push(t)
                ...
                destroy: function () {
                    return this.each(function () {
                        ...
                        e.unbind(".validation"), n.html(n.data("original-contents")), i.attr("class", i.data("original-classes")), e.attr("aria-invalid", e.data("original-aria-invalid")), n.attr("role", e.data("original-role")), t.indexOf(n[0]) > -1 && n.remove()
                    })
                },
            ...
            validatorTypes: {
                ...
                ajax: {
                    ...
                    validate: function (t, e, i) {
                        return "" + i.lastValue == "" + e && !0 === i.lastFinished ? !1 === i.lastValid : (!0 === i.lastFinished && (i.lastValue = e, i.lastValid = !0, i.lastFinished = !1, a.ajax({
                            url: i.url,
                ...
                regex: {
                    ...
                    init: function (a, t) {
                        var e;
                        return {
                            regex: (e = a.data("validation" + t + "Regex"), RegExp("^" + e + "$"))
                        }
                    },
                    validate: function (a, t, e) {
    ...
    a.fn.jqBootstrapValidation = function (t) {
        return e.methods[t] ? e.methods[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? (a.error("Method " + t + " does not exist on jQuery.jqBootstrapValidation"), null) : e.methods.init.apply(this, arguments)
